...
$cert = New-SelfSignedCertificate -CertStoreLocation "cert:\LocalMachine\My" -DnsName "cloudbot"
...
@{"thumprint" = $cert.Thumbprint; "applicationId" = $app.ApplicationId; "tenantID" = $tenant} | ConvertTo-Json > "C:\cloudbot\scripts\config\serviceprincipals\azure.json"